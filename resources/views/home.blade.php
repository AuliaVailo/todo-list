        ...
        <div class="bg-white m-5 w-full rounded-xl">
            ...
            <div class="p-5">
                <form action="" method="post">
                    ...
                    <div>
                        <input type="text" name="todo" id="todo" placeholder="Create simple web app..." class="bg-gray-200 w-full p-3 rounded-lg" required>
                    </div>
                </form>
            </div>
            <div class="p-3">
                ...
                <div class="flex justify-between">
                    ...
                    <div class="flex">
                        <a href="" class="bg-blue-500 p-2 text-white rounded-lg m-2">
